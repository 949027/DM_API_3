...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='При передаче URL страницы в качестве аргумента - '
                    'создается короткая ссылка (битлинк). При передаче '
                    'битлинка в качестве аргумента - выводится количество '
                    'переходов по нему.'
    )
